    ...
    <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
        <div
            ...
            <ul class="flex items-center flex-shrink-0 space-x-6">
                ...
                <!-- Profile menu -->
                <li class="relative">
                    <span class="cursor-pointer" @click='onClickShowProfile' >
                        ...
                        <button
                            ...
                            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQwOhTBIIoeqd_D1TDZni5MHPgu1IXfEVvby8tE7EMf18I6RdMHMkQEsS5XI_CVkK5KI_A&usqp=CAU"
                            alt=""
                            aria-hidden="true"
                            />
                        </button>
...
export default {
    ...
    mounted(){
        this.info = JSON.parse(localStorage.getItem('user')).data
        this.username = this.info.personal.username
    },
}
</script>